...
module Crm
  module Model::Contact
    ...
    included do
      ...
      validates :identity, uniqueness: { scope: [:client_id, :organ_id] }, allow_blank: true
    ...
    def sync_from_client_user
      ...
      self.identity ||= client_user.oauth_users.pluck(:identity)[0]
    end
